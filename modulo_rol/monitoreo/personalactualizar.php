...
?>
        ...
        <head>
            ...
            <link rel="stylesheet" href="css/actualizarpersonal.css">
        ...
        <body>
            ...
            <h2 class="h2-titulo">Actualizar Personal</h2>
            <hr>
            <?php
                    ...
                    <div class="blockk">
                        ...
                        <div class="block">
                            ...
                            <select name="cargoid">
                                ...
                                <option class="option" value="1">Profesor</option>
                                <option class="option" value="2">Secretaria(o)</option>
                                <option class="option" value="3">Estudiante</option>
                                <option class="option" value="5">Programador</option>
                            </select>
                        </div>
                        <div class="block">
                        ...
                        <div class="boton">
                            <button name="boton" value="guardar" type="submit" class="btn solid">Actualizar</button>
