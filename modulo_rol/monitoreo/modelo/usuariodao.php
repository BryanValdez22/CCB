...
class UsuarioDao extends Conexion
{
    ...
    public function Listapersonal()
    {
        ...
        apellidos, personal_institucion.fechanacimiento,personal_institucion.grado,cargo.nombrecargo,personal_institucion.idciudad,personal_institucion.barrio,personal_institucion.direccion,personal_institucion.email,personal_institucion.telefono FROM 
        personal_institucion,cargo WHERE 
        personal_institucion.cargoid=cargo.cargoid AND 
        cargo.nombrecargo <> 'visitante'AND 
        cargo.nombrecargo = 'estudiante';";
        $stmt = $conexion->prepare($sql);
        $stmt->execute();
        $array = $stmt->fetchAll(PDO::FETCH_ASSOC);
        $stmt = null;
