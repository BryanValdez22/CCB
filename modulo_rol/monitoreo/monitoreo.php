        ...
        <head>
            ...
            <style>
                .btn-buscar {
                    ...
                    font-size: 15px;
                    font-weight: 300;
                    box-shadow: 0 0 3px 0 rgba(0, 0, 0, 0.71);
                    border-radius: 3px;
                }
            </style>
            ...
            <div class="contenedor">
                <div class="bloque-primero">
                    ...
                    <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']) ?>" method="POST">
                        <div class="des">
                            ...
                            <button class="btn-buscar" type="submit" name="boton" value="accesorio">enviar</button>
                        </div>
                        <!-- textarea  -->
                ...
                <div class="bloque-segundo">
                    <div class="tabla">
                        ...
                        <button class="btn-buscar" type="submit" name="boton" value="buscar">Buscar</button>
