...
?>
        ...
        <body>
            ...
            <div class="container-fluid">
                <a href="datosempresa.php" class="btn btn-primary shadow-lg"><i class="fas fa-plus fa-lg"></i> Agregar empresa</a>
            </div><br>
            <div class="container-fluid">
                    ...
                    <tbody>
                        ...
                        foreach ($empresa as $datos) {
                            echo "<tr>" .
                                ...
                                "<td>&nbsp;&nbsp;&nbsp;&nbsp&nbsp;<a href='eliminarvis.php?identidadid=" . base64_encode($datos["nit"]) .
